            ...
            for (int p = 0; p < Lines[i].length(); p++) {
                ...
                if (Lines[i].charAt(p) == ',') {
                    ...
                    if (Lines[i].charAt(p) == 'B') {
                        ...
                        Converted_Info = "" + Block_x +", " + Block_y + ",\n";
        ...
        for (int z = 0; z < 1000; z++) {
            ...
            for (int y = 0; y < 1000; y++) {
                ...
                if (Grid[z][y] == true) {
                    ...
                    Converted_Info += "" + (Block_x + 1) + ", " + Block_y + ", 18, 10, 1,\n";

                    Converted_Info += "" + (Block_x + 1) + ", " + (Block_y + (height * 20)) + ", 18, 10, 3,\n";

                    Converted_Info += "" + (Block_x + 1) + ", " + (Block_y + 5) + ", 18, " + (-5 + (height * 20))  +", 2,\n"; 
